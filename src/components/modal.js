...
//const Modal = async ({item, setShowModal}) => {
export default function Modal({item, setShowModal}) {
    ...
    const getAvailability = async () => {
        const res = await availabilityService.getAvailability(item.manufacturer, item.id)
        return res
    }
